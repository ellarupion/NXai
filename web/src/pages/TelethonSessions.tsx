  ...
  return (
    <Card>
      ...
      <p className="mb-3 text-sm text-ink-muted">
        Читающий Telegram-аккаунт для пула Telethon (ARCHITECTURE.md §7) — заводится в
        три шага: номер телефона → код из Telegram → пароль двухфакторной
        аутентификации (если включена). Сам аккаунт ни во что не пишет и не
        публикует, только читает подписанные на него source_channels.
      </p>
...
export function TelethonSessions() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="text-sm text-ink-muted">
        Пул Telethon-сессий, читающих чужие source_channels. Каждый аккаунт держит
