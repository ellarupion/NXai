...
async def on_start(message: Message, bot_role: BotRole) -> None:
    ...
    await message.answer(
        ...
        "Вставьте его в поле «ID редактора» в панели — откройте вкладку темы этого бота "
        "(«Темы»), раздел «Бот и стиль» — и бот начнёт присылать сюда готовые посты на проверку."
    )
