...
from interfaces.bots.handlers.admin_review import router as admin_review_router
from interfaces.bots.handlers.admin_start import router as admin_start_router
from interfaces.bots.handlers.editor_review import router as editor_review_router

router = Router(name="nxai-channel-bot")
router.include_router(admin_start_router)
router.include_router(admin_review_router)
router.include_router(editor_review_router)
